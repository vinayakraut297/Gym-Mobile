...
import { User, LogOut, Shield, Coins, Bell, Moon } from 'lucide-react-native';
...
export default function SettingsScreen() {
  ...
  const handleSaveProfile = () => {
    updateUser({ name, phone, goal });
    Alert.alert('Profile Saved', 'Successfully updated your profile information.');
  };
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top', 'left', 'right']}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          ...
          <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Manage your preferences and tokens.</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Card style={{ marginVertical: 0 }}>
            ...
            <Input label="Fitness Goal" value={goal} onChangeText={setGoal} />
            <Button title="Save Changes" onPress={handleSaveProfile} style={{ marginTop: 16 }} />
          </Card>
        </View>

        {/* AI Billing Tokens */}
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: colors.textSecondary }]}>AI TOKEN BILLING</Text>
          <Card style={{ marginVertical: 0 }}>
            ...
            <Text style={[styles.tokenHelp, { color: colors.textSecondary }]}>
              Each AI message deducts 1 token. Top up anytime using UPI or cards.
            </Text>
            ...
            <View style={styles.topupGrid}>
              ...
              >
                ...
                <Text style={[styles.topupLabel, { color: colors.textSecondary }]}>Tokens</Text>
              ...
              <Pressable
                onPress={() => handleBuyTokens(1000, '₹599')}
                style={[styles.topupCard, { backgroundColor: colors.background, borderColor: colors.border }]}
              >
                <Text style={[styles.topupQty, { color: colors.text }]}>1000</Text>
                <Text style={[styles.topupLabel, { color: colors.textSecondary }]}>Tokens</Text>
                <Text style={[styles.topupPrice, { color: colors.primary }]}>₹599</Text>
              </Pressable>
            </View>
          </Card>
        </View>
